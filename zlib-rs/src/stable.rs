...
impl From<ReturnCode> for Result<Status, DecompressError> {
...
impl Decompress {
    ...
    pub fn reset(&mut self, zlib_header: bool) {
        let window_bits = InflateConfig::default().window_bits;
    ...
    pub fn decompress(
        ...
        unsafe { crate::inflate::inflate(&mut self.0, flush) }.into()
    }
}
